 ...
 * @ORM\Entity(repositoryClass="coevalParesRepository")
 */
class coevalPares{
...
protected $observaciones;
 ...
 /**
    * @var Evaluado
    * @ORM\ManyToOne(targetEntity="App\Entity\Docente", inversedBy="coevaldepar")
...
protected $evaluado;
 ...
 /**
    * @var Evaluador
    * @ORM\ManyToOne(targetEntity="App\Entity\Terna", inversedBy="evaluacion")
...
protected $evaluador;
     ...
     * Set evaluado
     *
     * @param \App\Entity\Docente $evaluado
     * @return coevalPares
     */
    public function setEvaluado(\App\Entity\Docente $evaluado)
    {
     ...
     * Set evaluador
     *
     * @param \App\Entity\Terna $evaluador
     * @return coevalPares
     */
    public function setEvaluador(\App\Entity\Terna $evaluador)
    {
