 ...
 * @ORM\Entity(repositoryClass="AvalplangRepository")
...
protected $avalado;
 ...
 /**
    * @var Plan
    * @ORM\ManyToOne(targetEntity="App\Entity\Plangestion", inversedBy="avales")
...
protected $user;
     ...
     * Set plan
     *
     * @param \App\Entity\Plangestion $plan
     * @return Avalplang
     */
    public function setPlan(\App\Entity\Plangestion $plan)
    {
        $this->plan = $plan;
