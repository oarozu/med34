 ...
 * @ORM\Entity(repositoryClass="coevalTutorRepository")
 */
class coevalTutor{

 /**
  * @ORM\Id
  * @ORM\OneToOne(targetEntity="App\Entity\Tutor", inversedBy="coevaltutor")
...
protected $observaciones;
     ...
     * Set tutor
     *
     * @param \App\Entity\Tutor $tutor
     * @return coevalTutor
     */
    public function setTutor(\App\Entity\Tutor $tutor)
    {
        $this->tutor = $tutor;
