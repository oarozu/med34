 ...
 * @ORM\Entity(repositoryClass="PlanmejoramientoRepository")
 */
...
/**
     * @var Docente
     * @ORM\ManyToOne(targetEntity="App\Entity\Docente", inversedBy="planmejoramiento")
...
protected $docente;
    ...
    /**
     * @ORM\OneToMany(targetEntity="App\Entity\Accionespm", mappedBy="plan")
     */
    protected $acciones;
     ...
     * Add acciones
     *
     * @param \App\Entity\Accionespm $acciones
     * @return Planmejoramiento
     */
    public function addAccione(\App\Entity\Accionespm $acciones)
    {
     ...
     * @param \App\Entity\Accionespm $acciones
     */
    public function removeAccione(\App\Entity\Accionespm $acciones)
    {
