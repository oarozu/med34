 ...
 * @ORM\Entity(repositoryClass="AccionespmRepository")
...
/**
     * @var Plan
     * @ORM\ManyToOne(targetEntity="App\Entity\Planmejoramiento", inversedBy="acciones")
...
protected $plan;
     ...
     * Set plan
     *
     * @param \App\Entity\Planmejoramiento $plan
     * @return Accionespm
     */
    public function setPlan(\App\Entity\Planmejoramiento $plan)
    {
        $this->plan = $plan;
     ...
     * Get plan
     *
     * @return \App\Entity\Planmejoramiento
     */
