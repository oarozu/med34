 ...
 * @ORM\Entity(repositoryClass="redTutoresRepository")
 */
class redTutores{
...
/**
 * @ORM\Id
 * @ORM\OneToOne(targetEntity="App\Entity\Tutor", inversedBy="coevaldirector")
...
protected $observaciones;
     ...
     * Set id
     *
     * @param \App\Entity\Tutor $id
     * @return redTutores
     */
    public function setId(\App\Entity\Tutor $id)
    {
        $this->id = $id;
