...
protected $escuela;
      ...
      /**
     * @var Programa
     * @ORM\ManyToOne(targetEntity="App\Entity\Programa", inversedBy="cursos")
...
protected $programa;
   ...
   /**
* @ORM\OneToMany(targetEntity="App\Entity\Oferta", mappedBy="curso")
*/
protected $oferta;
     ...
     * @return Curso
     */
    public function addOfertum(\App\Entity\Oferta $oferta)
    {
        $this->oferta[] = $oferta;
     ...
     * @param \App\Entity\Oferta $oferta
     */
    public function removeOfertum(\App\Entity\Oferta $oferta)
    {
