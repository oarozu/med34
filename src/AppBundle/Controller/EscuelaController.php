...
use AppBundle\Form\EscuelaType;
...
class EscuelaController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('AppBundle:Escuela')->findAll();
    ...
    public function showAction($id)
    {
        ...
        $terna = $em->getRepository('AppBundle:Terna')->findBy(array('escuela' => $entity, 'periodo' => $this->container->getParameter('appmed.periodo')));
