 ...
 * @ORM\Entity(repositoryClass="AppBundle\Entity\redTutoresRepository")
 */
class redTutores{
...
/**
 * @ORM\Id
 * @ORM\OneToOne(targetEntity="AppBundle\Entity\Tutor", inversedBy="coevaldirector")
...
protected $observaciones;
     ...
     * Set id
     *
     * @param \AppBundle\Entity\Tutor $id
     * @return redTutores
     */
    public function setId(\AppBundle\Entity\Tutor $id)
    {
        $this->id = $id;
