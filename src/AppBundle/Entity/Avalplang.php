 ...
 * @ORM\Entity(repositoryClass="AppBundle\Entity\AvalplangRepository")
...
protected $avalado;
 ...
 /**
    * @var Plan
    * @ORM\ManyToOne(targetEntity="AppBundle\Entity\Plangestion", inversedBy="avales")
...
protected $user;
     ...
     * Set plan
     *
     * @param \AppBundle\Entity\Plangestion $plan
     * @return Avalplang
     */
    public function setPlan(\AppBundle\Entity\Plangestion $plan)
    {
        $this->plan = $plan;
