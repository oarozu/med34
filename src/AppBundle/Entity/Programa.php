 ...
 * @ORM\Entity(repositoryClass="AppBundle\Entity\ProgramaRepository")
 */
class Programa{
...
protected $nivel;
     ...
     /**
     * @var Escuela
     * @ORM\ManyToOne(targetEntity="AppBundle\Entity\Escuela", inversedBy="programas")
...
protected $escuela;
    ...
    /**
     * @ORM\OneToMany(targetEntity="AppBundle\Entity\Docente", mappedBy="programa")
     */
    protected $docentes;


    /**
      * @ORM\OneToMany(targetEntity="AppBundle\Entity\Curso", mappedBy="programa")
      */
    protected $cursos;
