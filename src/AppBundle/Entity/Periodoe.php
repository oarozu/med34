...
class Periodoe
{
    ...
    /**
     * @ORM\OneToMany(targetEntity="AppBundle\Entity\Periodoa", mappedBy="periodoe")
     */
    protected $periodoa;
     ...
     * Add periodoa
     *
     * @param \AppBundle\Entity\Periodoa $periodoa
     * @return Periodoe
     */
    public function addPeriodoa(\AppBundle\Entity\Periodoa $periodoa)
    {
     ...
     * @param \AppBundle\Entity\Periodoa $periodoa
     */
    public function removePeriodoa(\AppBundle\Entity\Periodoa $periodoa)
    {
