 ...
 * @ORM\Entity(repositoryClass="AppBundle\Entity\ActividadrolRepository")
 */
class Actividadrol {
    ...
    /**
     * @var Rol
     * @ORM\ManyToOne(targetEntity="AppBundle\Entity\Rolacademico", inversedBy="actividades")
    ...
    /**
     * @var Responsabilidad
     * @ORM\ManyToOne(targetEntity="AppBundle\Entity\Responsabilidad")
     ...
     * Set responsabilidad
     *
     * @param \AppBundle\Entity\Responsabilidad $responsabilidad
     * @return Actividadrol
     */
    public function setResponsabilidad(\AppBundle\Entity\Responsabilidad $responsabilidad = null)
    {
     ...
     * Get responsabilidad
     *
     * @return \AppBundle\Entity\Responsabilidad
     */
