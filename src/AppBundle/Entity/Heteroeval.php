...
/**
  ...
  * @ORM\Entity(repositoryClass="AppBundle\Entity\HeteroevalRepository")
  */
class Heteroeval{
...
*/
 protected $docente;
     ...
     * Add cursos
     *
     * @param \AppBundle\Entity\Heterocursos $cursos
     * @return Heteroeval
     */
    public function addCurso(\AppBundle\Entity\Heterocursos $cursos)
    {
        $this->cursos[] = $cursos;
