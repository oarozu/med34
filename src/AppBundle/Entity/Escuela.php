...
protected $secretaria;
    ...
    /**
     * @ORM\OneToMany(targetEntity="AppBundle\Entity\Programa", mappedBy="escuela")
     */
    protected $programas;

     /**
     * @ORM\OneToMany(targetEntity="AppBundle\Entity\Docente", mappedBy="escuela")
     */
    protected $docentes;

    /**
    * @ORM\OneToMany(targetEntity="AppBundle\Entity\Terna", mappedBy="escuela")
    */
    protected $ternados;
     ...
     * Add ternados
     *
     * @param \AppBundle\Entity\Terna $ternados
     * @return Escuela
     */
    public function addTernado(\AppBundle\Entity\Terna $ternados)
    {
     ...
     * @param \AppBundle\Entity\Terna $ternados
     */
    public function removeTernado(\AppBundle\Entity\Terna $ternados)
    {
